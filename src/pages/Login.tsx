    ...
    <div className="min-h-screen flex items-center justify-center px-margin-mobile md:px-margin-desktop py-20">
      <div className="w-full max-w-md">
        ...
        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input type="checkbox" className="w-4 h-4 rounded border-white/10 bg-surface-container-low accent-primary" />
              <span className="font-body-md text-body-md text-on-surface-variant">تذكرني</span>
            </label>
            <button className="font-body-md text-body-md text-primary hover:text-secondary transition-colors">
              نسيت كلمة المرور؟
            </button>
          </div>
        ...
        <p className="mt-8 text-center font-body-md text-body-md text-on-surface-variant">
          ليس لديك حساب؟{' '}
          <button onClick={() => navigate('/signup')} className="text-primary hover:text-secondary transition-colors font-bold">
            إنشاء حساب جديد
          </button>
        </p>
      </div>
